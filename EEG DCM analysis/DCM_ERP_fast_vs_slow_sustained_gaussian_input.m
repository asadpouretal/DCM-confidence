...
%--------------------------------------------------------------------------
condition_name = params.fast_slow_condition_name;
...
for condition = 1: length(condition_name)
    ...
    Pbase     = fullfile(params.fast_slow_result_path, 'SPM Analyses');        % directory with your data, 
    parfor subject_number = 1 : num_of_subjects
        ...
        %--------------------------------------------------------------------------
        DCM.Lpos  = params.fastslow_Lpos;
        DCM.Sname = params.fastslow_Sourcename;
        ...
        %--------------------------------------------------------------------------
    %     DCM.xU.X = [0 1; 1 0];
    %     DCM.xU.name = {'Slow vs Fast', 'Fast vs Slow'};
        
        %--------------------------------------------------------------------------
        % Invert
        %--------------------------------------------------------------------------
        DCM.name = 'DCM_CMC_M1_Fast_Slow';
